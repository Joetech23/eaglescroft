...
export const faqs: Faq[] = [
  ...
  {
    q: 'Can you set up AI chatbots, automations and CRM systems?',
    a: 'Yes — that is one of our core strengths. We build AI chatbots that qualify leads 24/7, automation workflows that remove manual work, and complete GoHighLevel funnel + CRM systems that capture, nurture and convert leads on autopilot.',
  },
  {
  ...
  },
  {
    ...
    a: 'We partner, we don’t just build. One senior team across engineering, design, growth and AI automation — one accountable partner, faster delivery, and systems engineered to win customers, not just look good.',
  },
]
